  ...
  return (
    <nav className="flex flex-col gap-6 rounded-2xl border border-white/10 bg-white/5 px-6 py-4 backdrop-blur sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-medium uppercase tracking-[0.35em] text-white/60">Nguyen Tran</p>
          <p className="text-sm text-white/70">Product Designer / Frontend Engineer</p>
        </div>
      </div>
